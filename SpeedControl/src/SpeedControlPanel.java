...
private JPanel controls, speedPanel;
// --------------------------------------------
...
// ----------------------------------------------------
    public void actionPerformed(ActionEvent action)
        ...
        moveX = moveX * -1;
        if (y <= 0 || y >= HEIGHT - slideH - BALL_SIZE)
        moveY = moveY * -1;
        repaint();
        }
}
