...
public class IntListTest
	...
	public static void dispatch(int choice)
	{
		...
		switch(choice)
		{
			...
			break;
			case 5: // replace
			System.out.println("Enter an old val to look for");
			newVal = scan.nextInt();
			System.out.println("Enter an old val to replace with");
			newValb = scan.nextInt();
			list.replace(newVal, newValb);
			break;
			case 6: // length
	...
	public static void printMenu()
	{
		...
		System.out.println("5: Replaces all occurrences of oldVal in the list with newVal");
		System.out.println("6: Returns the number of elements in the list");
		System.out.println("7: Removes the last element of the list");
		System.out.print("\nEnter your choice: ");
	}
}